<h2>1840. Maximum Building Height</h2><h3>Hard</h3><hr><div><p>You want to build <code>n</code> new buildings in a city. The new buildings will be built in a line and are labeled from <code>1</code> to <code>n</code>.</p>
