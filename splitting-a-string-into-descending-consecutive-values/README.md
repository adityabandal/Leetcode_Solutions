<h2>1849. Splitting a String Into Descending Consecutive Values</h2><h3>Medium</h3><hr><div><p>You are given a string <code>s</code> that consists of only digits.</p>
